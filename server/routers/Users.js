...
router.post('/register', userValidationRules(), validation, checkEmail, async (req, res) => {
  try {
...
router.post('/check-username', usernameValidationRules(), validation, async (req, res) => {
  try {
...
router.post('/resend-otp', async (req, res) => {
  try {
    ...
    if (!user || user.isActive) return res.status(404).json({ message: 'User not found or already verified' });
...
router.post('/update', authenticationToken, userUpdateValidationRules(), validation, async (req, res) => {
  try {
